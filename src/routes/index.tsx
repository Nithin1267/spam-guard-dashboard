  ...
  head: () => ({
    meta: [
      { title: "SpamSense — Client-Side Email Spam Classifier" },
      {
        name: "description",
        content:
          "Detect spam before it reaches your inbox. SpamSense is a privacy-focused, client-side spam classifier using keyword and heuristic analysis.",
      },
      { property: "og:title", content: "SpamSense — Client-Side Email Spam Classifier" },
      {
        property: "og:description",
        content:
          "Paste any email and analyze it instantly with a transparent heuristic model. All processing happens locally.",
      },
    ],
  }),
